import { applyCorrections, PrLensRenderError, renderAll, THEMES, type Theme } from "@contour/renderer";
import { safeParseGraphDoc, type Config, type GraphDoc } from "@contour/schema";
