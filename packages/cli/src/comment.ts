...
import type { GraphDoc, Lens, RenderAsset, RenderManifest, View } from "@contour/schema";
...
const PROJECT_URL = "https://contour.dev";
const CONTOUR_URL = "https://contour.dev";
...
export const composeComment = (options: CommentOptions): string => {
  ...
  const footer = branding
    ? `<sub>◈ Rendered by <a href="${CONTOUR_URL}">Contour</a></sub>`
    : "";
