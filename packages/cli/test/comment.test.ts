import { parseRenderManifest, type RenderManifestInput } from "@contour/schema";
import { minimalGraph, postmarkRefactorGraph, postmarkRefactorManifest } from "@contour/schema/examples";
